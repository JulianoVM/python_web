...
def dt(num_max_depth, num_max_features, num_random_state):
    iris = load_iris()
    X = iris.data
    y = iris.target
    ...
    clf = DecisionTreeClassifier(max_depth=num_max_depth, max_features=num_max_features, random_state=num_random_state)
